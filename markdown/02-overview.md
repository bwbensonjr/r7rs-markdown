...
chapters [Basic concepts](04-basic-concepts.md#basicchapter) through [Standard procedures](07-standard-procedures.md#builtinchapter). For reference
purposes, section [Formal semantics](08-formal-syntax-and-semantics.md#formalsemanticssection) provides a formal
semantics of Scheme.
...
syntactic sugar. See section [Proper tail recursion](04-basic-concepts.md#proper-tail-recursion).
...
backtracking, and coroutines. See section [Control features](07-standard-procedures.md#continuations).
...
(section [External representations](08-formal-syntax-and-semantics.md#datumsyntax)), not as program.

The formal syntax of Scheme is described in section [Formal syntax](08-formal-syntax-and-semantics.md#bnf).
...
the procedure `raise` as described in section [Exceptions](07-standard-procedures.md#exceptionsection). The object raised is implementation-dependent
...
report, are to be interpreted as described in RFC 2119 [[rfc2119](14-references.md#cite-rfc2119)].
...
Chapters [Expressions](05-expressions.md#expressionchapter) and [Standard procedures](07-standard-procedures.md#builtinchapter) are organized
...
as defined in Appendix [Standard Libraries](09-standard-libraries.md#stdlibraries).
...
section [Disjointness of types](04-basic-concepts.md#disjointness), then it is an error if that argument is not of the named type.
...
| *list*, *list*₁, $\dots$ *list*ⱼ, $\dots$ | list (see section [Pairs and lists](07-standard-procedures.md#listsection)) |
...
that can be represented externally by the sequence of characters “`40`.” See section [External representations](04-basic-concepts.md#externalreps) for a discussion of external
...
allocated locations (see section [Storage model](04-basic-concepts.md#storagemodel)).
