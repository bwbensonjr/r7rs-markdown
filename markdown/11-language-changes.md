...
the “Revised$^5$ report” [[R5RS](14-references.md#cite-r5rs)].
...
- New disjoint types supporting access to multiple fields can be
  generated with the `define-record-type` of SRFI 9 [[srfi9](14-references.md#cite-srfi9)]
...
- Support for promises has been enhanced based on SRFI 45 [[srfi45](14-references.md#cite-srfi45)].
...
the “Revised$^6$ report” [[R6RS](14-references.md#cite-r6rs)] and its accompanying Standard Libraries document.
...
- The semantics of `map` and `for-each` have been changed to use
  the SRFI 1 [[srfi1](14-references.md#cite-srfi1)] early termination behavior. Likewise,
...
- String ports are compatible with SRFI 6 [[srfi6](14-references.md#cite-srfi6)] rather than R⁶RS.
- R⁶RS-style bytevectors are included, but
  ...
  with SRFI 4 [[srfi4](14-references.md#cite-srfi4)], rather than the R⁶RS `#vu8` style.
